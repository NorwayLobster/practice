...
static void InitDefaultsscc_info_SearchResult_serialization_2equeryResult_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SearchResult_serialization_2equeryResult_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SearchResult_serialization_2equeryResult_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_serialization_2equeryResult_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_serialization_2equeryResult_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_serialization_2equeryResult_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_serialization_2equeryResult_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, query_),
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, page_number_),
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, result_per_page_),
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, id_),
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, str_),
  PROTOBUF_FIELD_OFFSET(::Search::SearchResult, opt_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::Search::SearchResult)},
};
...
const char descriptor_table_protodef_serialization_2equeryResult_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\037serialization.queryResult.proto\022\006Searc"
  "h\"q\n\014SearchResult\022\r\n\005query\030\001 \001(\t\022\023\n\013page"
  "_number\030\002 \001(\005\022\027\n\017result_per_page\030\003 \001(\005\022\n"
  "\n\002id\030\004 \001(\005\022\013\n\003str\030\005 \001(\t\022\013\n\003opt\030\006 \001(\005b\006pr"
  "oto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_serialization_2equeryResult_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_serialization_2equeryResult_2eproto_sccs[1] = {
  &scc_info_SearchResult_serialization_2equeryResult_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_serialization_2equeryResult_2eproto_once;
static bool descriptor_table_serialization_2equeryResult_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_serialization_2equeryResult_2eproto = {
  &descriptor_table_serialization_2equeryResult_2eproto_initialized, descriptor_table_protodef_serialization_2equeryResult_2eproto, "serialization.queryResult.proto", 164,
  &descriptor_table_serialization_2equeryResult_2eproto_once, descriptor_table_serialization_2equeryResult_2eproto_sccs, descriptor_table_serialization_2equeryResult_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_serialization_2equeryResult_2eproto::offsets,
  file_level_metadata_serialization_2equeryResult_2eproto, 1, file_level_enum_descriptors_serialization_2equeryResult_2eproto, file_level_service_descriptors_serialization_2equeryResult_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_serialization_2equeryResult_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_serialization_2equeryResult_2eproto), true);
namespace Search {
...
SearchResult::SearchResult(const SearchResult& from)
  ...
  ::memcpy(&page_number_, &from.page_number_,
    ...
    reinterpret_cast<char*>(&page_number_)) + sizeof(opt_));
  // @@protoc_insertion_point(copy_constructor:Search.SearchResult)
}

void SearchResult::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SearchResult_serialization_2equeryResult_2eproto.base);
  query_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  str_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Search.SearchResult.query"));
          CHK_(ptr);
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Search.SearchResult.str"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 opt = 6;
...
::PROTOBUF_NAMESPACE_ID::uint8* SearchResult::_InternalSerialize(
  ...
  if (this->opt() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(6, this->_internal_opt(), target);
  }
